...
if __name__ == "__main__":
    ...
    #all stop words are removed from the created dicitonries
    for word in stop_words:
        if word in spam_vector:
            del spam_vector[word]
        if word in ham_vector:
            del ham_vector[word]
        if word in vocab_vector:
            del vocab_vector[word]
    ...
    print("\nNaive Bayes metrics for the data without stop words ")
    ...
    print("\nNaive Bayes(without stop words) total accuracy for Test Emails: " + str(total_accuracy) + "%")
